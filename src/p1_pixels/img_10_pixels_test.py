...
# python3 img_10_pixels_test.py
# python3 img_10_pixels_test.py  Test_active_pixel_group_detection.test_active_pixel_group_detection
...
# python3 img_10_pixels_test.py Test_pixelgroup_matrix_repr_select_corner
class Test_pixelgroup_matrix_repr_select_corner(unittest.TestCase):
    ...
    def test_select_top_left_coord(self):
        ...
        coordSelected, _err = img_10_pixels.pixelgroup_matrix_repr_select_corner_coord(
            pixelGroups_Glyphs[0].matrix_representation, wantedCorner=("top", "left"))
        print(f"topLeft relative coord: {coordSelected}")
        self.assertEqual(coordSelected, [(2, 0)])

        coordSelected, err = img_10_pixels.pixelgroup_matrix_repr_select_corner_coord([])
        ...
        #### ABS top-left:
        coordSelected, _err = img_10_pixels.pixelgroup_matrix_repr_select_corner_coord(
            pixelGroups_Glyphs[0].matrix_representation, wantedCorner=("top", "left"), wantedCoordType="absInPage")
        print(f"topLeft absolute coord: {coordSelected}")
        self.assertEqual(coordSelected, [(4, 1)])

        #### ABS top-right:
        coordSelected, _err = img_10_pixels.pixelgroup_matrix_repr_select_corner_coord(
            pixelGroups_Glyphs[0].matrix_representation, wantedCorner=("top", "right"), wantedCoordType="absInPage")
        print(f"topRight absolute coord: {coordSelected}")
        self.assertEqual(coordSelected, [(6, 1)])

        #### ABS bottom-left:
        coordSelected, _err = img_10_pixels.pixelgroup_matrix_repr_select_corner_coord(
            pixelGroups_Glyphs[0].matrix_representation, wantedCorner=("bottom", "left"), wantedCoordType="absInPage")
        print(f"bottomLeft absolute coord: {coordSelected}")
        self.assertEqual(coordSelected, [(2, 4)])

        #### ABS bottom-right:
        coordSelected, _err = img_10_pixels.pixelgroup_matrix_repr_select_corner_coord(
            pixelGroups_Glyphs[0].matrix_representation, wantedCorner=("bottom", "right"), wantedCoordType="absInPage")
        print(f"bottomRight absolute coord: {coordSelected}")
        self.assertEqual(coordSelected, [(6, 4)])

        #### REL bottom-right:
        coord, _err = img_10_pixels.pixelgroup_matrix_repr_select_corner_coord(
            pixelGroups_Glyphs[0].matrix_representation, wantedCorner=("bottom", "right"), wantedCoordType="relativeInMatrix")
...
# python3 img_10_pixels_test.py  Test_drop_group_collector
class Test_drop_group_collector(unittest.TestCase):
    ...
    def test_drop_collector_simple(self):
        ...
        emptyGroup = img_13_pixel_select.coords_drop_collect_pixelgroups_from_starting_point(
            ...
            wantedRepresentedPixelGroupNames={img_10_pixels.pixelsNameBackgroundInactive},
...
# python3 img_10_pixels_test.py Test_collect_relative_matrix_coords
class Test_collect_relative_matrix_coords(unittest.TestCase):
    ...
    def test_collect_relative_matrix_coords(self):
        ...
        coordsInactiveInMatrix = img_10_pixels.pixelGroup_matrix_representation_collect_matrix_coords_with_represented_names(
            pixelGroups_Glyphs[0].matrix_representation, {img_10_pixels.pixelsNameBackgroundInactive}
        )
...
class TestLoadImageFile(unittest.TestCase):
    ...
    def test_load_image_file_incorrect_channel_number(self):
        ...
        with patch("PIL.Image.open") as mocked_fun:
            ...
            _pixelsInImg, errors, warnings = img_10_pixels.pixels_load_from_image(imgPath)
...
# python3 img_10_pixels_test.py Test_matrix_representation_xAbsLeft_yAbsTop_xAbsRight_yAbsBottom
...
# python3 img_10_pixels_test.py  Test_matrix_representation
class Test_matrix_representation(unittest.TestCase):
    ...
    # python3 img_10_pixels_test.py  Test_matrix_representation.test_matrix_representation_output
    def test_matrix_representation_output(self):
        ...
        matrixReprStr = img_10_pixels.pixelGroup_matrix_representation_convert_to_str__forHumanReadingInTerminal(matrixRepresentationOfPixelGroup)
        print(matrixReprStr)
    ...
    # python3 img_10_pixels_test.py  Test_matrix_representation.test_matrix_representation_without_matrix_repr_data
    def test_matrix_representation_without_matrix_repr_data(self):
        matrixReprStr = img_10_pixels.pixelGroup_matrix_representation_convert_to_str__forHumanReadingInTerminal(
            list(), printStr=True)
    ...
    def test_matrix_representation_empty_area(self):
        pixelGroupForBackgroundNonActivePixels = \
            img_10_pixels.PixelGroup_Glyph(representedPixelGroupName=img_10_pixels.pixelsNameBackgroundInactive)
        ...
        areaPixels = img_10_pixels.pixelGroup_matrix_representation_empty_area_create(
            pixelGroupForBackgroundNonActivePixels,
    ...
    # in src/p1_pixels dir: python3 img_10_pixels_test.py  Test_matrix_representation.test_matrix_representation_with_active_pixels__no_empty_border_around_representation
    def test_matrix_representation_with_active_pixels__no_empty_border_around_representation(self):
        ...
        print(f"Test: {testName}")
        img_10_pixels.pixelGroup_matrix_representation_convert_to_str__forHumanReadingInTerminal(matrixRepresentationOfPixelGroup, printStr=True)

        y = 0 # matrixRepresentation is y,x based!!!!
        x = 0
        self.assertTrue(img_10_pixels.pixelsNameBackgroundInactive in matrixRepresentationOfPixelGroup[y][x][2].representedPixelGroupNames)
        ...
        """)
        self.assertTrue(img_10_pixels.pixelsNameForegroundActive in matrixRepresentationOfPixelGroup[y][x][2].representedPixelGroupNames)


    # in src/p1_pixels dir: python3 img_10_pixels_test.py  Test_matrix_representation.test_matrix_representation_with_active_pixels__extra_empty_border_around_representation
...
# python3  img_10_pixels_test.py  Test_pixelGroup_matrix_representation_has_emptyborder_around_glyph
class Test_pixelGroup_matrix_representation_has_emptyborder_around_glyph(unittest.TestCase):
    ...
    def test_pixelGroup_matrix_representation_has_emptyborder_around_glyph(self):
        ...
        pixelGroups_Glyphs[0].matrix_representation_refresh()
        img_10_pixels.pixelGroup_matrix_representation_convert_to_str__forHumanReadingInTerminal(pixelGroups_Glyphs[0].matrix_representation, printStr=True)

        self.assertFalse(img_10_pixels.pixelGroup_matrix_representation_has_emptyborder_around_glyph(pixelGroups_Glyphs[0].matrix_representation, raiseExceptionIfNoBorder=False))

        # missing empty border around the pixelGroup, there are pixels
        self.assertRaises(ValueError,
                         img_10_pixels.pixelGroup_matrix_representation_has_emptyborder_around_glyph,
                         pixelGroups_Glyphs[0].matrix_representation,
        ...
        self.assertFalse( img_10_pixels.pixelGroup_matrix_representation_has_emptyborder_around_glyph(
                           list(), False) )
